...
The three files look like this :
	...
	![Alt text](/images/EXECUTION_ROOT.png?raw=true)


    Matrix of permissions :
	
	![Alt text](https://raw.githubusercontent.com/Yacine101/CTF_SOLUTIONS/master/images/ACCESS_MATRIX.png)
  
    Passwd : 

	![Alt text](/images/PASSWD.png?raw=true)
...
On execution of check_32 we find that no user has access to the files , why ? Maybe the program checks for file read capability judging by the file owner . If this is true , Linux can not give 2 people ownership !! This will be a problem .
...
After checking for the outputs and the functions used , it seems that the group solution should have worked , without further sticking to the 1st solution we will go for the second ! using GDB !
